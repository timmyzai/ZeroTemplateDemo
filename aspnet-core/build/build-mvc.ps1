...
$webMvcFolder = Join-Path $slnFolder "src/PepperMintDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/PepperMintDemo.Web.Public"
...
dotnet restore PepperMintDemo.Web.sln
