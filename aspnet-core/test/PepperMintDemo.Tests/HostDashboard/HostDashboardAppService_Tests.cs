...
using PepperMintDemo.MultiTenancy.HostDashboard;
...
namespace PepperMintDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PepperMintDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
