...
using PepperMintDemo.Web.Public.Startup;
using PepperMintDemo.Web.Session;

namespace PepperMintDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PepperMintDemoViewComponent
    {
