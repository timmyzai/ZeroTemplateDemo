...
namespace PepperMintDemo.Core.Base
{
    public abstract class PepperMintDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PepperMintDemoQueryBase(string fieldName,
