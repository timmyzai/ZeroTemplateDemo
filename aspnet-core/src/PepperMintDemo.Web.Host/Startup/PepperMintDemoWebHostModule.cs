...
using PepperMintDemo.Authorization.Users.Password;
using PepperMintDemo.Configuration;
using PepperMintDemo.EntityFrameworkCore;
using PepperMintDemo.MultiTenancy;
using PepperMintDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace PepperMintDemo.Web.Startup
{
    ...
    public class PepperMintDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PepperMintDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PepperMintDemoWebHostModule).GetAssembly());
        }
