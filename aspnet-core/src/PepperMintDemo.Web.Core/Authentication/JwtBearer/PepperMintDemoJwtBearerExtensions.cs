...
/// </summary>
public static class PepperMintDemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, PepperMintDemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
