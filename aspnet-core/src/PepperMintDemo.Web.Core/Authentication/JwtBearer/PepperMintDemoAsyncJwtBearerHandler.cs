...
{
    public class PepperMintDemoAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public PepperMintDemoAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
