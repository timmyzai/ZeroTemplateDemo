...
using PepperMintDemo.Authentication.TwoFactor;
...
using PepperMintDemo.Web.Authentication.JwtBearer;
using PepperMintDemo.Web.Authentication.TwoFactor;
using PepperMintDemo.Web.Chat.SignalR;
using PepperMintDemo.Web.Common;
using PepperMintDemo.Web.Configuration;
using PepperMintDemo.Web.DashboardCustomization;
using Abp.Extensions;

namespace PepperMintDemo.Web
{
    [DependsOn(
        typeof(PepperMintDemoApplicationModule),
        typeof(PepperMintDemoEntityFrameworkCoreModule),
    ...
    public class PepperMintDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PepperMintDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PepperMintDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PepperMintDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PepperMintDemoWebCoreModule).Assembly);
        }
