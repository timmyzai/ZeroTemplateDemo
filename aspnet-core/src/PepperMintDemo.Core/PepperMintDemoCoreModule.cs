...
using PepperMintDemo.Authorization.Delegation;
using PepperMintDemo.Authorization.Ldap;
using PepperMintDemo.Authorization.Roles;
using PepperMintDemo.Authorization.Users;
using PepperMintDemo.Chat;
using PepperMintDemo.Configuration;
using PepperMintDemo.DashboardCustomization.Definitions;
using PepperMintDemo.Debugging;
using PepperMintDemo.DynamicEntityProperties;
using PepperMintDemo.Features;
using PepperMintDemo.Friendships;
using PepperMintDemo.Friendships.Cache;
using PepperMintDemo.Localization;
using PepperMintDemo.MultiTenancy;
using PepperMintDemo.Net.Emailing;
using PepperMintDemo.Notifications;
using PepperMintDemo.WebHooks;
using Newtonsoft.Json;

namespace PepperMintDemo
{
    [DependsOn(
        typeof(PepperMintDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PepperMintDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PepperMintDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PepperMintDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PepperMintDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PepperMintDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PepperMintDemoCoreModule).GetAssembly());
        }
