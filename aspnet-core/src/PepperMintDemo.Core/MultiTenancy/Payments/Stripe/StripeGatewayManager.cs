...
{
    public class StripeGatewayManager : PepperMintDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PepperMintDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PepperMintDemoConsts.Currency;
        }
