...
{
    public class PepperMintDemoMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public PepperMintDemoMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(PepperMintDemoConsts.LocalizationSourceName, name);
        }
    }
}