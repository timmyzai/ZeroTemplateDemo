...
namespace PepperMintDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PepperMintDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PepperMintDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
