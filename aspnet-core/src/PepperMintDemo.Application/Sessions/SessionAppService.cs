...
{
    public class SessionAppService : PepperMintDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = PepperMintDemoConsts.Currency,
                        CurrencySign = PepperMintDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = PepperMintDemoConsts.AllowTenantsToChangeEmailSettings,
