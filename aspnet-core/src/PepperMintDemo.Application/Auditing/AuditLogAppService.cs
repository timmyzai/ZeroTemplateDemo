...
using PepperMintDemo.Auditing.Exporting;
...
using EntityHistoryHelper = PepperMintDemo.EntityHistory.EntityHistoryHelper;

namespace PepperMintDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PepperMintDemoAppServiceBase, IAuditLogAppService
    {
