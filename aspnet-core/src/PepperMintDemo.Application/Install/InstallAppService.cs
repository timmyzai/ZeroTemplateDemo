...
namespace PepperMintDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PepperMintDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PepperMintDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{PepperMintDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PepperMintDemoConsts.ConnectionStringName}", constring);
        }
