...
using PepperMintDemo.Authorization.Permissions;
...
using PepperMintDemo.Authorization.Users.Exporting;
...
namespace PepperMintDemo.Authorization.Users
{
    ...
    public class UserAppService : PepperMintDemoAppServiceBase, IUserAppService
    {
