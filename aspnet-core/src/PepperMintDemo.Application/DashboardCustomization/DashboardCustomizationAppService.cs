...
using PepperMintDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace PepperMintDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PepperMintDemoAppServiceBase, IDashboardCustomizationAppService
    {
