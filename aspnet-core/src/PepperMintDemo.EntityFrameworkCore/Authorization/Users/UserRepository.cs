...
{
    public class UserRepository : PepperMintDemoRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<PepperMintDemoDbContext> dbContextProvider)
