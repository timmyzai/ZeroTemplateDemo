...
{
    public class SubscriptionPaymentRepository : PepperMintDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PepperMintDemoDbContext> dbContextProvider)
