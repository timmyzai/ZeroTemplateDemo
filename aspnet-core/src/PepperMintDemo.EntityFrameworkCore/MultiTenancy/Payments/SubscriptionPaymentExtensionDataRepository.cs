...
using PepperMintDemo.EntityFrameworkCore.Repositories;

namespace PepperMintDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PepperMintDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PepperMintDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
