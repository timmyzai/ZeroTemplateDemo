...
namespace PepperMintDemo.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PepperMintDemoConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(PepperMintDemoDbContext context)
        {
            _context = context;
        }
