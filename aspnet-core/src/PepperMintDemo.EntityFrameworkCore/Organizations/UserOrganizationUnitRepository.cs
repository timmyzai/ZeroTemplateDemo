...
namespace PepperMintDemo.Organizations
{
    public class UserOrganizationUnitRepository : PepperMintDemoRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<PepperMintDemoDbContext> dbContextProvider)
