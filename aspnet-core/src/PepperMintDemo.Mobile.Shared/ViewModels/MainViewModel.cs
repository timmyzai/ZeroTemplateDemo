...
using PepperMintDemo.Commands;
using PepperMintDemo.Core.Threading;
using PepperMintDemo.Models.NavigationMenu;
using PepperMintDemo.Services.Navigation;
...
using PepperMintDemo.ApiClient;
using PepperMintDemo.Controls;
using PepperMintDemo.Dto;
using PepperMintDemo.Extensions;
using PepperMintDemo.Localization;
using PepperMintDemo.UI;
using PepperMintDemo.UI.Assets;
using PepperMintDemo.Views;
using DependencyResolver = PepperMintDemo.Core.Dependency.DependencyResolver;
...
namespace PepperMintDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PepperMintDemo";
